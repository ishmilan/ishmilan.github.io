<template>
    <div>
        <div class="card">
            ...
            <p>Ademas, si quieres hacer una donación para que pueda seguir desarrollando el proyecto que quieras,
                puedes hacerlo desde el botón de paypal indicando la canitdad y el nombre del proyecto al que va destinado
                y te convertirás en sponsor de ese proyecto.</p>
        </div>
...
export default {
    data() {
        return {
            username: 'ishmilan',
            reponames: ['ikextremadura','fireworks','PMH','bindcfg','ishmilan.github.io'],
            repos: []
        };
    },
    mounted() {
        ...
        if(repos){
            ...
            axios
                ...
                .then((response)=>{
                    ...
                    localStorage.setItem(`github-${this.username}`,JSON.stringify(this.repos));
                })
